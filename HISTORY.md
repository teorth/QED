...
* **Version 2.7.3** (released Aug 30, 2018).  New records for Exercise 9.5(c), 12.4(a).  Exercise 1.1 changed to something more useful and less cluttering; text for first few exercises adjusted accordingly.
