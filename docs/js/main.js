...
// predicates, terms, sentences, functions, operators that are used in exercises and laws.
...
var Pb = predicateSentence(P,[beta]);
...
var lawsData = {
    ...
    "BarbaraSingular":            [[forAll(IMPLIES(PX,QX),X), Pa, alpha],                               Qa],
    "ExistentialRenamingBoundVar":[[thereExists(PX,X),toTerm(Y)],                                       thereExists(PY,Y)],
...
var exerciseData = {
    ...
    "18.3(a)":  ["BarbaraSingular"],
    "18.3(b)":  [[forAll(IMPLIES(PX,QX),X), forAll(IMPLIES(RX,PX),X)], forAll(IMPLIES(RX,QX),X),
                    [forAll(IMPLIES(A,B),X), forAll(IMPLIES(C,A),X)], forAll(IMPLIES(C,B),X)],
    "18.4":     [[forAll(forAll(QXY,Y),X)], forAll(forAll(QXY,X),Y),
                    [forAll(forAll(A,Y),X)], forAll(forAll(A,X),Y)],
    "18.5":     [[formulaContext(PX), formulaContext(QX), toTerm(X)], IFF( forAll( AND(PX,QX), X ), AND(forAll(PX,X), forAll(QX,X))),
                    [formulaContext(A), formulaContext(B), toTerm(X)], IFF( forAll( AND(A,B), X), AND(forAll(A,X), forAll(B,X)))],
    "18.6":     [[formulaContext(A), formulaContext(PX), toTerm(X)], IFF( IMPLIES(A, forAll( PX, X )), forAll(IMPLIES(A,PX),X)),
                    [formulaContext(A), formulaContext(B), toTerm(X)], IFF( IMPLIES(A, forAll( B, X )), forAll(IMPLIES(A,B),X))],
    ...
    "22.3(a)":  [[formulaContext(PX), X, formulaContext(Px)], IFF( NOT(thereExists(PX, X)), forAll(NOT(PX),X)),
                    [formulaContext(A), X], IFF( NOT( thereExists(A,X)), forAll(NOT(A), X))],
    "22.3(b)":  [[formulaContext(PX), X, formulaContext(Px)], IFF( NOT(forAll(PX, X)), thereExists(NOT(PX),X)),
                    [formulaContext(A), X], IFF( NOT( forAll(A,X)), thereExists(NOT(A), X))],
    "22.4(a)":  [[NOT(thereExists(AND(PX,QX),X)), forAll(IMPLIES(RX,PX),X), formulaContext(Px), formulaContext(Qx), formulaContext(Rx)], NOT(thereExists(AND(RX,QX),X)),
                    [NOT(thereExists(AND(A,B), X)), forAll(IMPLIES(C,A),X)], NOT(thereExists(AND(C,B),X))],
    "22.4(b)":  [[forAll(IMPLIES(PX,QX),X), thereExists(AND(RX,PX),X)], thereExists(AND(RX,QX),X),
                    [forAll(IMPLIES(A,B),X), thereExists(AND(C,A),X)], thereExists(AND(C,B),X)],
    "22.4(c)":  [[NOT(thereExists(AND(PX,QX),X)), thereExists(AND(RX,PX),X), formulaContext(Px), formulaContext(Qx), formulaContext(Rx)], thereExists(AND(RX,NOT(QX)),X),
                    [NOT(thereExists(AND(A,B),X)), thereExists(AND(C,A),X)], thereExists(AND(C, NOT(B)),X)],
    "22.4(d)":  [[forAll(IMPLIES(PX,QX), X), thereExists(AND(RX,NOT(QX)),X)], thereExists(AND(RX,NOT(PX)),X),
                    [forAll(IMPLIES(A,B),X), thereExists(AND(C, NOT(B)), X)], thereExists(AND(C, NOT(A)),X)],
    "22.4(e)":  [[thereExists(AND(PX, NOT(QX)), X), forAll(IMPLIES(PX,RX), X), formulaContext(Px), formulaContext(Qx), formulaContext(Rx)], thereExists(AND(RX,NOT(QX)),X),
                    [thereExists(AND(A, NOT(B)), X), forAll(IMPLIES(A,C),X)], thereExists(AND(C,NOT(B)),X)],
    "22.5(a)":  [[forAll(IMPLIES(PX,QX), X), forAll(IMPLIES(QX,RX),X), thereExists(PX, X)], thereExists(AND(PX,RX),X),
                    [forAll(IMPLIES(A,B), X), forAll(IMPLIES(B,C), X), thereExists(A, X)], thereExists(AND(A,C),X)],
    "22.5(b)":  [[NOT(thereExists(AND(PX,QX),X)), forAll(IMPLIES(RX,PX),X), thereExists(RX, X), formulaContext(Px), formulaContext(Qx), formulaContext(Rx)], thereExists(AND(RX,NOT(QX)),X),
                    [NOT(thereExists(AND(A,B), X)), forAll(IMPLIES(C,A), X), thereExists(C, X)], thereExists(AND(C, NOT(B)), X)],
    "22.5(c)":  [[forAll(IMPLIES(PX,QX),X), NOT(thereExists(AND(RX,QX),X)), thereExists(RX,X), formulaContext(Px), formulaContext(Qx), formulaContext(Rx)], thereExists(AND(RX,NOT(PX)),X),
                    [forAll(IMPLIES(A,B),X), NOT(thereExists(AND(C,B),X)), thereExists(C,X)], thereExists(AND(C, NOT(A)), X)],
    "22.5(d)":  [[NOT(thereExists(AND(PX,QX),X)), forAll(IMPLIES(PX,RX),X), thereExists(PX,X), formulaContext(Px), formulaContext(Qx), formulaContext(Rx)], thereExists(AND(RX, NOT(QX)),X),
                    [NOT(thereExists(AND(A,B), X)), forAll(IMPLIES(A,C),X), thereExists(A,X)], thereExists(AND(C, NOT(B)), X)],
    "22.5(e)":  [[forAll(IMPLIES(PX,QX),X), forAll(IMPLIES(PX,RX),X), thereExists(PX,X)], thereExists(AND(RX, QX),X),
                    [forAll(IMPLIES(A,B),X), forAll(IMPLIES(A,C),X), thereExists(A,X)], thereExists(AND(C, B), X)],
    ...
    "22.6(b)":  [[thereExists(forAll(QXY,X),Y)], forAll(thereExists(QXY,Y),X),
                    [thereExists(forAll(A,X),Y)], forAll(thereExists(A,Y),X)],
    "22.6(c)":  ["ExistentialRenamingBoundVar"],
    ...
    "22.8":     [[forAll(IMPLIES(PX,NOT(QX)),X), forAll(IMPLIES(NOT(QX),RX),X), NOT(thereExists(AND(RX,SX),X)), formulaContext(Px), formulaContext(Qx), formulaContext(Rx), formulaContext(Sx)], forAll(IMPLIES(PX, NOT(SX)),X),
                    [forAll(IMPLIES(A,NOT(B)),X), forAll(IMPLIES(NOT(B),C),X), NOT(thereExists(AND(C,D),X))], forAll(IMPLIES(A, NOT(D)),X)],
    ...
    "24.8":     [[forAll(equals(multiply(one,X),X),X), forAll(forAll(forAll(equals(multiply(X,multiply(Y,Z)),multiply(multiply(X,Y),Z)), Z), Y), X), forAll(thereExists(equals(multiply(Y,X),one),Y),X)], equals(multiply(alpha,one),alpha)]
};
